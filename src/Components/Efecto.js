    ...
    <div className="flex flex-col items-center px-2.5">
      ...
      <div>
        <div className="flex py-2">
          <div>
            <h3 style={{ backgroundColor: "black", color: "white" }}>Sin dependecias:</h3>
          </div>
          <div>
            <p >
        ...
        <div className="flex py-2">
          <div>
            <h3 style={{ backgroundColor: "black", color: "white" }}>Con dependecias vacias:</h3>
          </div>
          <div>
            <p>
        ...
        <div className="flex py-2">
          <div>
            <h3 style={{ backgroundColor: "black", color: "white" }}>Con un valor en las dependecias:</h3>
          </div>
          <div>
