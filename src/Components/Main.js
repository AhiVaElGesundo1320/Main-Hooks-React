...
export const Main = () => {
  ...
  const resizeWindow = () => {
    windowSize.innerWidth <= mobileSize
      ? setWindowSize(true)
      : setWindowSize(false);
  };
...
*/}
  return (
    <div className="flex flex-col my-8 ">
      <div className="w-full flex flex-col items-center sm:flex sm:flex-row sm:justify-evenly">
        <div className=" lg:mx-3 lg:w-screen lg:flex lg:flex-row lg:justify-center">
          <NavLink to={"/estado"}>
            ...
            <NavLink to={"/efecto"}>
              <div class=" div-main max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div class="px-6 py-4">
                  ...
                  <p class="text-gray-700 text-base">
                    Este es un pequeño resumen con ejemplos en el que te
                    explicare de una manera basica sobre como funciona el hook
                    useEffect
                  </p>
                </div>
                <div class="px-6 pt-4 pb-2">
